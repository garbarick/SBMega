...
public class MegaApiJava {
    ...
    */
    ...
    public MegaChildren getFileFolderChildren(MegaNode parent, int order){
        ...
        MegaNodeList nodes = megaApi.getChildren(parent, order);
        ArrayList<MegaNode> fileList = new ArrayList<MegaNode>();
        ArrayList<MegaNode> folderList = new ArrayList<MegaNode>();
        ...
        children.setFileList(fileList);
        children.setFolderList(folderList);
